  ...
  return (
    <div className="flex">
      ...
      <div className="w-[20%] h-screen bg-gray-900 text-white font-funnel">
        ...
        <ul className="mt-4">
          <li
            ...
            className={`p-4 cursor-pointer flex hover:bg-gray-700 ${
              selectedComponent === 'dashboard' ? 'bg-gray-700' : ''
            }`}
          >
            <svg
              className="w-[2em]"
          ...
          <li
            ...
            className={`p-4 cursor-pointer flex hover:bg-gray-700 ${
              selectedComponent === 'createGroup' ? 'bg-gray-700' : ''
            }`}
          >
            <svg
              className="w-[2em]"
            ...
            <span className="flexCol ml-[0.5em]">Create Group</span>
          </li>

          <li
            onClick={() => setSelectedComponent('groups')}
            className={`p-4 cursor-pointer flex hover:bg-gray-700 ${
              selectedComponent === 'groups' ? 'bg-gray-700' : ''
            }`}
          >
            <svg
              className="w-[2em]"
            ...
            <span className="flexCol ml-[0.5em]">Groups</span>
          </li>

          <li
            onClick={() => setSelectedComponent('mywallets')}
            className={`p-4 cursor-pointer flex hover:bg-gray-700 ${
              selectedComponent === 'mywallets' ? 'bg-gray-700' : ''
            }`}
          >
            <svg
              className="w-[2em]"
      ...
      <div className="flex-1 bg-gray-800 text-white p-6">
        ...
        {selectedComponent === 'groups' && <JoinGroup />}
        {selectedComponent === 'createGroup' && <CreateGroup />}
      </div>
    </div>
  )
}
