    ...
    <div className="bg-black">
      <div className="relative w-full h-[120vh] overflow-hidden">
        ...
        <div className="relative w-[90%] mx-auto py-[20vh] font-funnel">
          <h1 className="text-white font-bold font-orbitron text-[64px] leading-[1.2em]">
            Decentralized Savings & <br />
            Lending for Millions{" "}
          </h1>
          <p className="text-blue-500 font-funnel text-[32px]">
            Transparent. Trustless. Global.
          </p>
          ...
          <div className="flex gap-[2em] mt-[2em]">
            ...
            {isConnected ? (
              ...
              >
                <div className="flexCol leading-[1em]">+</div>
                <div className="flexCol">Browse Chamas</div>
                <div className="flexCol">
                  <svg
                    className="w-[0.8em]"
                    viewBox="0 0 13 12"
              ...
              <ConnectButton label="Join a Chama" />
            )}

            <a
              href=""
              className="border-[2px] border-blue-500 text-white flex w-fit text-[26px] gap-[0.5em] rounded-[100px] px-[20px] py-[5px] font-funnel"
            >
              ...
              <div className="flexCol">
                ...
                >
                  <path
                    d="M5.46967 12.5793C5.76256 12.8722 6.23744 12.8722 6.53033 12.5793L11.3033 7.80634C11.5962 7.51345 11.5962 7.03857 11.3033 6.74568C11.0104 6.45279 10.5355 6.45279 10.2426 6.74568L6 10.9883L1.75736 6.74568C1.46447 6.45279 0.989593 6.45279 0.696699 6.74568C0.403806 7.03857 0.403806 7.51345 0.696699 7.80634L5.46967 12.5793ZM5.25 0.048584L5.25 12.049H6.75L6.75 0.048584L5.25 0.048584Z"
                    fill="white"
                  />
                </svg>
              </div>
          ...
          <div className="bg-gray-800 lightGrayBg text-white p-[15px] rounded-[20px] w-fit mt-[50px]">
            <div className="flex text-[24px] gap-[0.3em]">
              ...
              <div className="flexCol py-[0.5em]">Live Chama Pools</div>
            </div>
